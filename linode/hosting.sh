...
# <UDF name="SMTP_RELAY" label="SMTP relay for entire system (usually not required), e.g. '[mail.clientname.com.au]:587'" default="" />
...
set | grep -E '^(NODE_(HOSTNAME|FQDN|TIMEZONE|SERVICES)|PATH_PREFIX|ADMIN_EMAIL)=' |
